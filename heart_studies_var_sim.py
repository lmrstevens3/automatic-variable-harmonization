...
def doc_similarity(data_file, doc_cols, ref_id_col, filter_file=None, word_vectors=None, corpora_col=None):
    #load data
...
def calc_scores_doc_cols(data_file, doc_cols_input, ref_id_col, filter_file,  word_vectors=None, corpora_col=None):
    ...
    for key in doc_cols_input:
        ...
        scores_df = doc_similarity(data_file, doc_cols_input[key], ref_id_col, filter_file, word_vectors, corpora_col)
...
obs_scores_embed = calc_scores_doc_cols(obs_data_file, doc_cols_obs, ref_id_col, obs_man_file, word_vectors=biowordvec_embeddings)
...
#biowordvec embeddings with regular tfidf
trials_scores_embed = calc_scores_doc_cols(trials_data_file, doc_cols_trials, ref_id_col, trials_man_file, word_vectors=biowordvec_embeddings)
