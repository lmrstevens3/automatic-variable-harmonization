...
class TestCorpusBuilder(TestCase):
    ...
    def test_calc_tfidf_multi_corpus(self):
        ...
        corpora = [[('race1', ['variable', 'describing',
                               'group', 'individual', 'certain',
                               'characteristic', 'common', 'owing',
                               'common', 'inheritance']),
                    ('gender1', ['variable', 'describing',
                                 'self', 'identified', 'category',
                                 'basis', 'sex']),
                    ('sex1', ['variable', 'descriptive',
                              'biological', 'characterization', 'based',
                              'gamete', 'gonad', 'individual']),
                    ('ethnicity1', ['due', 'shared',
                                    'cultural', 'background'])],
                   [('race2', ['race', 'describing',
                               'group', 'individual', 'certain',
                               'characteristic', 'common', 'owing',
                               'common', 'inheritance']),
                    ('gender2', ['gender', 'describing',
                                 'self', 'identified', 'category',
                                 'basis', 'sex']),
                    ('sex2', ['sex', 'descriptive',
                              'biological', 'characterization', 'based',
                              'gamete', 'gonad', 'individual']),
                    ('ethnicity2', ['affiliation',  'shared',
                                    'cultural', 'background'])],
                   [('race3', ['race', 'variable',
                               'group', 'individual', 'certain',
                               'characteristic', 'common', 'owing',
                               'common', 'inheritance']),
                    ('gender3', ['gender', 'variable',
                                 'self', 'identified', 'category',
                                 'basis', 'sex']),
                    ('sex3', ['sex', 'variable',
                              'biological', 'characterization', 'based',
                              'gamete', 'gonad', 'individual']),
                    ('ethnicity3', ['affiliation', 'due',
                                    'cultural', 'background'])]]
        tfidf_matrix = corpus.calc_tfidf(corpora)
